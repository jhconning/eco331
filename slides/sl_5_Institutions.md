...
- North, Douglas, 1990. "An Introduction to Institutions and Institutional Change", Chapter 1 in _Institutions, Institutional Change, and Economic Performance_. Cambridge.
...
• Experience of centuries of war (e.g. 30 years war 1618-1648) and dogma. 
Kings vs parliaments.

• Rising challenges to absolutism, aristocracy  
and arbitrary power. 
...
## Classical Liberals
   *  John Locke, David Hume, Adam Smith, Wilhelm von Humboldt, Thomas Jefferson, Jean-Batiste Say, Frederich Hayek, Ludwig von Mises ...  
      ...
      * Self interest as motivator. Spontaneious order. 
...
- Main barrier are 'bad policies' that distort markets and slow growth.  
Blame on rent-seeking bureaucrats and 'special interests.'
...
*  The $\epsilon_t$ "residual" term could be interpreted as TFP $A_t$ plus perhaps other factors (e.g. geography, human capital, etc).  
$$\ln Y_{it} = b_0 + b_1  t + b_2 \cdot \ln K_{it} + b_3 \cdot \ln L_{it} + b_4 \cdot X_it + \epsilon_{it}$$
...
- Models imply constant or increasing returns to factor accumulation, rather than standard neo-classical diminishing returns to capital or human capital 
(e.g. productivity of new engineer higher where there are more engineers).
...
- What do neo-institutionalists, and Marxians have in commmon?
  - Materialist conception of history
  - Institutions matter
  - Institutions are shaped by evolutionary proceseses and conflict. 
...
(though a lot of Marxian analysis can be tiresome, tedious, heavy handed or just plain bad ... e.g. endless debates about taxonomies, single-minded focus on exploitative relations, Soviet propaganda, etc).
...
- Private ownership *may* involve a variety of rights:
  - right to appropriate stream of rents from us e and investments in the resource.
  - right to exclude others from access
  - right to rent, sell or otherwise trnsfer.
- PRs may be based on 
  - formal arrangements (constitutional provisions, statures, judicial decisions).
...
- Oliver Cromwell, victor of earlier English Civil War (1642-1651). Professionalized army (removed Nobility from leadership roles). Also led colonization of Ireland and wholesale exropriation of Irish Lands. 
...
- Prior to Korean War, North and South were highly comparable (North was more ndustrial!). 
