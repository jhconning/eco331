...
modified: 2025-01-30T12:00:00.000Z
marp: true
paginate: true
---
...
- Diamond, J., 1999. "The Worst Mistake in the History of the Human Race". Discover Magazine. 
- Scott, J.C., 2017. "Population Control: Bondage and War," Chapter 5 in _Against The Grain_. Yale University Press.
...
* 25% newborns died < age 1. Mother childbirth deaths common.
...
![bg center: 60%](attachments/growth2020.png)
...
* **Technological progress:** getting more for less
    ...
    * may be embodied in new methods, tools, forms of organization
* **Human Capital**: factors that influence worker productivity (training, problem-solving skill, health and longevity)
...
* **Prestige-biased learning**: copy successful, high-status individuals
...
* **Geographic pattern**: High gene frequency in pastoral populations
...
<!-- PART III: MIGRATION & HUNTER-GATHERER LIFE -->
...
- Most humans today from a significant migration out of Africa 60-90K years ago
 ...
 - Reaches 
   ...
   - Cross Bering Strait in several migrations 14-23K years ago.

---
## Megafauna Extinction in the Americas

* By time humans reach Americas, hunting methods are highly evolved. 
...
* In Africa, large animals **co-evolved** with human hunters over millions of years
* Animals learned to fear humans; developed escape behaviors
* Result: Africa retained its megafauna (elephants, rhinos, lions)

* In the Americas and Australia, animals had **no evolutionary experience** with human predators
* They were naive prey → rapid extinction
...
- Significant social strata rarely emerged
- Mobile lifestyle following seasonal resources
...
* Hunter-gatherers worked *15-20 hours per week* for subsistence
* Diverse, nutritious diets; extensive leisure time. Low material possessions by choice, not deprivation

Diamond, Scott add political dimension:

* For most of history, people **fled** states when they could
* Periphery was a refuge, not a wasteland. "Barbarians" **choose** freedom over domus
...
* **Taller stature** than early agriculturalists
* **Better dental health** (less carbohydrate decay)
* **Fewer signs of nutritional stress**
* **Lower disease burden** (small, mobile groups limit epidemics)

Early farmers show: shorter stature, more cavities, signs of anemia, repetitive stress injuries
...
(see [xkcd](https://xkcd.com/1732/) chart)
* Warmer, wetter, and crucially **more stable** conditions
* Green Sahara period (~10,000-5000 years ago)
* This stability mattered: agriculture requires predictability

The wild ancestors of wheat, barley, lentils grew naturally in the Fertile Crescent
...
* Concentration of domesticable plants: wheat, barley, lentils, chickpeas
* Concentration of domesticable animals: sheep, goat, cattle, pig

**Jared Diamond's point:** Geography gave some regions a head start
...
* Suggests agriculture as **solution** to scarcity

**Implication:** Agriculture was progress, enabling larger populations and eventually civilization

This view is not uncontested.
...
* New epidemic diseases from animal proximity and crowding

**Beyond health:**
* Harder work: more hours than foraging
* Worse nutrition: dependence on fewer crops
* Inequality: surplus enables elites
* Bondage: dense populations can be controlled
...
* Grain is visible, storable, divisible, taxable
* States form where grain makes populations "legible"
* Tubers, forest products: can be hidden, left in ground

<br>

* Longer term implications for state formatiorn and development

---

## The Grain Thesis

Why grain? From the state's perspective:
...
This is what Scott means by "legibility" — states need to see and count their subjects and their produce

---

## Domesticable Species

- Only 14 large animals have been domesticated: sheep, goat, cow, pig, horse, Arabian camel, Bactrian camel, llama/alpaca, donkey, reindeer, water buffalo, yak, Bali cattle, Mithan.

- Fertile Crescent had 4 of these
- Most in Eurasia
- Agricultural technology harder to spread North-South (different latitudes/climates)
...
* Decline in average stature
* Increase in dental cavities
* Signs of anemia and nutritional deficiency
* Repetitive stress injuries from grinding grain
* New diseases from animal proximity
...
1. **Pushed**: Climate change, population pressure, declining wild resources forced the transition

2. **Pulled**: Elites emerged who benefited from controlling surplus and coerced others into farming

3. **Trapped**: Once adopted, populations grew; couldn't return to foraging even if worse off

The transition was **gradual, halting, and sometimes reversed**
...
- Rich alluvium soils but volatile rivers
- Irrigation required — but extraordinarily productive
- Kingship, temples, and code of laws emerge
...
* Dated ~3200-3000 BCE
* Carved alabaster, approximately 1 meter tall
* One of the earliest narrative artworks
* Discovered in the Eanna temple complex, dedicated to goddess Inanna
...
* Each level supports and feeds into the one above
* **Surplus as sacred duty**: Tribute is cosmic obligation, not theft
* **Workers are naked; elites are clothed**
* The vertical reading naturalizes the flow of tribute upward

The temple mediates between humans and divine forces. Agricultural surplus ensures continued fertility and protection.
...
- Hunter Gatherer societies 
  - Small-scale, kinship ties, cooperation, sharing
  - Significant social strata rarely emerged

- Early agricultural settlements maintained such arrangements
  - Combined agriculture with hunter-gathering
  - At times abandoned agriculture

- But settlements grew; populations became denser
  - Rulers, noblemen, priests, artists, soldiers emerge
...
* What advantages/disadvantages conferred by agricultural revolutions?
  * Disadvantages
    ...
    * Taxes, stratification, bondage and slavery
  * Advantages
...
|---------------------|------------------------|----------------------|
| Scott, early Hobbes | Social contract theory | Olson |
| State extracts surplus through coercion | State solves coordination problems | Bandit settles down, invests in tax base |
| Walls keep people *in* | Walls keep enemies *out* | Both: protection + extraction |
| Slavery, bondage central | Defense, irrigation central | Ruler's interest aligned with subjects |

---

## Olson: Roving vs. Stationary Bandits

**Roving Bandit:**
* Raids, takes what he can, moves on
* No incentive to leave anything behind
* Maximizes short-term extraction

**Stationary Bandit:**
* Settles, claims territory, becomes "ruler"
* Has incentive to let subjects prosper (larger future tax base)
* Provides some public goods (protection, order)
* "An invisible hand guides him to produce the public good"

---

## Olson's Logic

The stationary bandit's incentive:

* If he takes 50% of output, he wants output to be as large as possible
* So he provides order, property rights, basic public goods
* His interests partially align with subjects' interests

**But:** Still extracts as much as he can without killing the goose
**And:** Subjects would prefer no bandit at all

This is a **theory of autocracy**, not democracy or voluntary cooperation
...
* When land is abundant, people can **flee** oppressive rulers
* States lack the power to prevent "leakage"
* Early legal codes obsessed with runaways, escapees

* **Ester Boserup**: Only when population becomes dense and land scarce can elites control by owning land alone
* Until then: bondage, slavery, walls, forced resettlement

---

## Chayanov and Peasant Logic

A.V. Chayanov showed:

* Peasant families produce enough for sufficiency, then stop
* No incentive to produce surplus without compulsion
* "Beyond sufficiency... there was no reason to increase the drudgery of agricultural production"

**Implication:** Surplus doesn't exist naturally — the state creates it through extraction

---

## Mesopotamian Warfare

Seth Richardson's research on early Mesopotamian wars:

* Wars were **not primarily about territory**
* They were about **capturing populations**
* Petty wars to conquer smaller communities and bring them to the "grain core"
* The prize was captives — especially women and children
* "The state with the most people was generally richest"

---

## "No Slavery, No State"

Scott argues bondage was central to early states:

* War captives as labor force
* Debt bondage trapped locals
* Corvée labor for public works
* Women captives for reproduction

* As late as 1800, perhaps three-quarters of world's population in some form of bondage
* Athens: slaves were two-thirds of population
...
- 1374 5x5km grid cells covering area between modern Euphrates and Tigris
...
- The 'identification' problem: Estimates might be 'biased' due to other factors that coincide with the shifts.
- Verify parallel trends assumption
- Argue river shift truly exogenous (not man-made)
- Argue no bias in archaeological evidence
- Placebo test: areas where river shifted *closer* (expect negative effect)
...
Constrained by institutions but also attempt to change institutions.

---

## Summary: Why Did States Emerge?

No single answer — likely all factors played a role:
...
* How do these patterns of state formation shape long-run development?
* Why do some regions develop strong states, others weak?
* How do property rights and institutions evolve?
