...
theme: gaia 
paginate: true
footer: Eco 331: Industrial Revolution
style: |
...
- - Cheasapeake region, sugar, tobacco, rice
...
$$
MPL_i = (1-\alpha) \cdot \frac{Q_i}{L_i} \hspace{1cm} MPT_i = \alpha \cdot \frac{Q_i}{T_i}
$$
...
- Barbara Solow mentions the ideas of E.B. Wakefield and Evsy Domar on land and labor institutions in labor scarce environments.
...
>On the other hand, of course, it has not always worked that way. England's peasants were not re-enserfed after the Black Death drove up their wages; attempts to build a system of indentured white servitude in America failed; slavery was abolished; and in the modern world wages do more or less reflect marginal productivity.
...
### Free Land + Free Labor  (no landlord rentier class)
  ...
  - Landlords cannot earn low land rents (no rentier class)
    ...
    - labor is expensive because labor is scarce (landlords would have to pay a wage equal to what labor can earn ny establishing their own farms)
...
<br>
Hence Free Land (frontier) may lead to either free labor or labor coercion.  Depends on relative politicall strength of landlords and laborers.
...
---
Even where outright slavery or sefdom are outlawed, dominant groups have attempted to limit labor's mobility as well as access to land.
...
- [Shorter blog summary](https://cepr.org/voxeu/columns/slavery-and-british-industrial-revolution)
- [VoxTalks podcast interviews authors](https://cepr.org/multimedia/slavery-and-industrial-revolution)
...
- [source](https://storymaps.arcgis.com/stories/337186bd22f8404ea60cec7753dde9d6)
